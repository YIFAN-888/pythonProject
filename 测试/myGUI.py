        ...
        #while self.timer_camera.isActive() == True:
            ...
            for i in range(1, 7):
                if num[i] >= 4:
                    ...
                    break
            if res == 1:
                self.label_show_recognition.setText('打开ppt')
                ...
                hwnd = win32gui.FindWindow(None, "ppt.pptx - WPS Office")
                hwnd1 = win32gui.FindWindow(None, "gesture recognition")
                ...
                self.label_show_recognition.setText('放映')
                hwnd_title = {}
                def get_all_hwnd(hwnd, mouse):
                    if (win32gui.IsWindow(hwnd)
                            and win32gui.IsWindowEnabled(hwnd)
                ...
                self.label_show_recognition.setText('程序3')


            elif res == 4:
                self.label_show_recognition.setText('程序4')

            elif res == 5:
                self.label_show_recognition.setText('程序5')

            elif res == 6:
                self.label_show_recognition.setText('程序6')
